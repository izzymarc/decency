    ...
    <main className="home-page">
      ...
      <section className="about-us-section">
        ...
        <div className="about-us-content">
          <img src={AboutUsImage} alt="About Us" className="about-us-section-image" />
